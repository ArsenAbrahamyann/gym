...
public class TraineeControllerSteps {
    ...
    public void iRegisterATraineeWithDetails(List<Map<String, String>> trainees) {
        try {
    ...
    public void iRegisterATraineeWithInvalidDetails(List<Map<String, String>> trainees) {
        try {
            TraineeRegistrationRequestDto requestDto = new TraineeRegistrationRequestDto();
    ...
    public void iRequestTheProfileForTrainee(String username) {
        try {
    ...
    public void iRequestTheProfileForNonExistentTrainee(String username) {
        try {
    ...
    public void iUpdateTheProfileForTraineeWithDetails(List<Map<String, String>> trainees) {
        try {
    ...
    public void iUpdateTheProfileForTraineeWithInvalidDetails(List<Map<String, String>> trainees) {
        try {
            UpdateTraineeRequestDto requestDto = new UpdateTraineeRequestDto();
            requestDto.setUsername(trainees.get(0).get("username"));
            requestDto.setFirstName(trainees.get(0).get("firstName"));
    ...
    public void iToggleTheStatusForTraineeWithDetails(List<Map<String, String>> trainees) {
        try {
    ...
    public void iRequestTheUnassignedTrainersForTrainee(String username) {
        try {
    ...
    public void iUpdateTheTrainerListForTraineeWithDetails(List<Map<String, String>> trainees) {
        try {
