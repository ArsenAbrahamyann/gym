...
public class TrainingControllerSteps {
    ...
    public void iRequestTheTrainingListForTrainee(String traineeName) {
        try {
    ...
    public void iRequestToDeleteATrainingWithID(Long trainingId) {
        try {
    ...
    public void aTrainingWithIDExists(Long trainingId) {
        TrainingEntity trainingEntity = new TrainingEntity();
    ...
    public void iAddATrainingWithDetails(List<Map<String, String>> trainingDetails) {
        try {
