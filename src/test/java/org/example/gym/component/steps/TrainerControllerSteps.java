...
/**
 * Cucumber steps for testing the {@link TrainerController}.
 */
public class TrainerControllerSteps {
    ...
    /**
     * Sets up a mock trainer entity based on the provided data.
     *
     * @param trainers A list of maps representing trainer details.
     */
    ...
    /**
     * Registers a trainer with the provided details.
     *
     * @param trainers A list of maps representing trainer details.
     */
    @When("I register a trainer with details")
    public void registerATrainerWithDetails(List<Map<String, String>> trainers) {
        try {
    ...
    /**
     * Registers a trainer with invalid details.
     *
     * @param trainers A list of maps representing trainer details.
     */
    @When("I register a trainer with invalid details")
    public void registerATrainerWithInvalidDetails(List<Map<String, String>> trainers) {
        try {
            TrainerRegistrationRequestDto requestDto = new TrainerRegistrationRequestDto();
            requestDto.setFirstName(trainers.get(0).get("firstName"));
            requestDto.setLastName(trainers.get(0).get("lastName"));
    ...
    /**
     * Checks the HTTP status code of the trainer registration response.
     *
    ...
    /**
     * Requests the profile of a trainer by username.
     *
     * @param username The username of the trainer.
     */
    @When("I request the profile for trainer {string}")
    public void requestTheProfileForTrainer(String username) {
        try {
    ...
    /**
     * Requests the profile of a non-existent trainer.
     *
     * @param username The username of the trainer.
     */
    @When("I request the profile for non-existent trainer {string}")
    public void requestTheProfileForNonExistentTrainer(String username) {
        try {
    ...
    /**
     * Checks the HTTP status code of the trainer profile response.
     *
     * @param statusCode The expected HTTP status code.
     */
    ...
    /**
     * Updates the profile of a trainer with the provided details.
     *
     * @param trainers A list of maps representing trainer details.
     */
    @When("I update the profile for trainer with details")
    public void updateTheProfileForTrainerWithDetails(List<Map<String, String>> trainers) {
        try {
    ...
    /**
     * Updates the profile of a trainer with invalid details.
     *
     * @param trainers A list of maps representing trainer details.
     */
    @When("I update the profile for trainer with invalid details")
    public void updateTheProfileForTrainerWithInvalidDetails(List<Map<String, String>> trainers) {
        try {
            UpdateTrainerRequestDto requestDto = new UpdateTrainerRequestDto();
            requestDto.setUsername(trainers.get(0).get("username"));
            requestDto.setFirstName(trainers.get(0).get("firstName"));
            ...
            when(trainerService.updateTrainerProfile(requestDto))
                    .thenThrow(new IllegalArgumentException("Invalid data"));
    ...
    /**
     * Checks the HTTP status code of the update trainer profile response.
     *
     * @param statusCode The expected HTTP status code.
     */
     ...
     *
     * @param trainers A list of maps representing trainer details, including the new active status.
     */
    @When("I toggle the status for trainer with details")
    public void toggleTheStatusForTrainerWithDetails(List<Map<String, String>> trainers) {
        try {
    ...
    /**
     * Validates the HTTP response status for trainer profile request.
     *
    ...
    /**
     * Requests the workload of a trainer for a specific month.
     *
     * @param username The username of the trainer.
     * @param month    The month for which workload is requested.
     */
    @When("I request the workload for trainer {string} for month {int}")
    public void requestTheWorkloadForTrainerForMonth(String username, Integer month) {
        try {
    ...
    public void requestTheWorkloadForTrainerForMonthWithTimeout(String username, Integer month) {
        try {
    ...
    /**
     * Validates the HTTP response status for trainer workload request.
     *
     * @param statusCode Expected HTTP status code.
     */
