...
/**
 * Cucumber steps for testing the {@link TrainerService}.
 */
public class TrainerServiceStepDefs {
    ...
    /**
     * Sets up a new trainer with valid details, mocking the necessary repositories and services.
     */
    @Given("a new trainer data with valid details")
    public void new_trainer_data_with_valid_details() {
    ...
    /**
     * Attempts to create the trainer profile using the {@link TrainerService}.
     */
    @When("I attempt to create the trainer profile")
    public void attempt_to_create_the_trainer_profile() {
        try {
    ...
    /**
     * Verifies that the trainer profile was created successfully.
     */
    ...
    /**
     * Sets up an existing trainer with a specified username, mocking the necessary repositories and services.
     */
    ...
    /**
     * Toggles the active status of the trainer using the {@link TrainerService}.
     */
    @When("I toggle the trainer's active status")
    public void toggle_the_trainer_s_active_status() {
        try {
    ...
    /**
     * Verifies that the trainer's status was updated successfully.
     */
    ...
    /**
     * Sets up a non-existent trainer username, mocking the necessary repositories and services.
     */
    @Given("a non-existent trainer username")
    public void non_existent_trainer_username() {
        TrainerRepository trainerRepository = mock(TrainerRepository.class);
    ...
    /**
     * Verifies that toggling the status of a non-existent trainer fails with an error.
     */
    ...
    /**
     * Sets up update details for a non-existent trainer.
     */
    ...
    /**
     * Attempts to update the profile of a non-existent trainer.
     */
    @When("I try to update the trainer's profile")
    public void try_to_update_the_trainer_s_profile() {
        try {
    ...
    /**
     * Verifies that updating the profile of a non-existent trainer fails with an appropriate error message.
     */
