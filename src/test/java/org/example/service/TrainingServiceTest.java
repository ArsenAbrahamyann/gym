...
//
//        // When
//        List<TrainingEntity> result = trainingService.getTrainingsForTrainee("traineeName", new LocalDateTime(),
//                new LocalDateTime(), "trainerName", "trainingType");
//
//        // Then
...
//        // When & Then
//        Exception exception = assertThrows(EntityNotFoundException.class, () -> {
//            trainingService.getTrainingsForTrainee("traineeName", new LocalDateTime(),
//                    new LocalDateTime(), "trainerName", "trainingType");
//        });
//        assertEquals("Trainee not found", exception.getMessage());
//    }
